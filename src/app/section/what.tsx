...
export default function What() {
  ...
  return (
    <Providers>
      <div id="features" className="px-4 sm:px-6 xl:px-20 py-8 xl:py-20 w-full max-w-[1440px] mx-auto my-16 xl:my-32 what-box relative">
          ...
          >
            ...
            >
              {items.map((item) => (
                ...
                >
                  <div className="bg-white rounded-[20px] px-6 py-8 shadow-lg">
        ...
        <div className="flex items-center justify-center mt-8 xl:mt-[16px]">
          <Button
            ...
            type="submit"
            className="flex mt-9 items-center justify-center gap-4.5 py-6 xl:py-8 px-4 xl:px-5 book-demo transition-all duration-300 ease-in w-fit"
          >
            <h1 className="text-lg xl:text-xl font-semibold text-white flex-auto text-center">
              Try Voice AI
            </h1>
            <div className="w-8 h-8 xl:w-9 xl:h-9 bg-white flex items-center justify-center rounded-full shrink-0">
              <ArrowRight className="w-3 xl:w-4 text-black" />
            </div>
          </Button>
        </div>
      </div>
